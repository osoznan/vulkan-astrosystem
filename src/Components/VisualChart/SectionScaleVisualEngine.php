...
trait SectionScaleVisualEngine {
    ...
    protected function drawBasic() {
        ...
        $this->chart->ring($this->_lineClipInnerRadius, $this->_lineClipOuterRadius, 'vul-scale-background');
    }
    ...
    public function drawCaption($sectorId, $text) {
        ...
        $this->chart->drawCaption($this->section, ($curr + $next) / 2, $text, 'vul-scale-caption');
    }
